...
public static class Strings
{
    ...
    public static string TipDirectInput(LanguageService lang) => lang.GetString("直接输入问题与 DotBot 对话", "Directly input questions to chat with DotBot");
    ...
    public static string McpConfigTip(LanguageService lang) => lang.GetString("在 appsettings.json 的 \"McpServers\" 中配置 MCP 服务器。", "Configure MCP servers in \"McpServers\" section of appsettings.json.");
