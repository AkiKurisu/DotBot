...
namespace DotBot.Commands.Custom;

/// <summary>
/// Discovers, loads and expands custom commands defined as markdown files.
/// Commands are loaded from workspace (.bot/commands/) and user (~/.bot/commands/) directories.
/// </summary>
public sealed partial class CustomCommandLoader(string workspaceRoot)
{
    ...
    public string UserCommandsPath { get; } = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), ".bot", "commands");
