...
Add the `DashBoard` config section in `appsettings.json`:
...
Start DotBot normally (supported in all modes). The console will output the DashBoard address:
